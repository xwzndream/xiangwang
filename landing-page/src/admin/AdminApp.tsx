...
type Project = { id:string; customer_id:string; name:string; project_type:string; deployment_enabled:boolean; status:string; delivered_at?:string; service_expires_at?:string; offline_at?:string };
